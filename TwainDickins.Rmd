...
Looking at this word chart, we see most strikingly that time is used as an anticipatory word, at a significantly higher rate than any other word for any other feeling. We also see that gentleman is used positively. Fire is an interesting word to see at the top of the fear column, even higher than death. "Boy" is used with a strong negative connotation in Dickens, perhaps characters say it in a fraternizing way.
